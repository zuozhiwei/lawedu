            ...
            <div class="panel panel-default">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            <button class="btn btn-primary" onclick="getCoursePracticeList()">刷新</button>
                        </div>
                        <div class="col-md-1">
                            <button class="btn btn-primary" onclick="addCoursePractice()">添加实践课程</button>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    $( function () {
        $("#coursePractice").addClass("active");
        getCoursePracticeList();
    });
    function getCoursePracticeList () {
        $.ajax({
            type : "POST",
            url : "../user/getCoursePracticeList",
            dataType : "json",
            data : {},
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div style="width: 90%;margin: 10px auto;">
                <form class="form-horizontal" id="coursePracticeCheckForm">
...
<div class="modal fade" id="courseAddBox" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                <button type="button" class="btn btn-primary" onclick="submitCourseAddBox()">修改</button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function courseUpdateBox (id) {
        ...
        $.ajax({
            type : "POST",
            url : "../user/getCoursePracticeInfo",
            dataType : "json",
            data : {
                "coursePracticeId" : id
            },
