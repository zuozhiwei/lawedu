        ...
        <div class="col-md-10">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">提问管理</h3>
                </div>
                <div class="container-fluid">
                    <div class="row">
                        <div class="well well-sm"></div>
                        <div class="col-md-1">
                            <button class="btn btn-primary" onclick="getAskList()">刷新</button>
                        </div>
                    </div>
                </div>
                <div class="panel-body">
                    <table id="table_ask" class="display">
                        <thead>
                        <tr>
                            <th>编号</th>
                            <th>学生id</th>
                ...
                $('#table_ask').DataTable({
                    ...
                    "columnDefs": [
                        ...
                        },
                        {
                            "render" : function(data, type, row, meta){
                                var btnHTML = '';
                                btnHTML += '<button type="button" onclick="askUpdateBox(\''+row.id+'\',\''+row.fromId+'\',\''+row.userName+'\',\''+row.toId+'\',\''+row.courseName+'\',\''+row.content+'\',\''+row.addTime+'\')" class="btn btn-primary">修改</button> ';
                                btnHTML += '<button type="button" onclick="askDeleteBox(\''+row.id+'\')" class="btn btn-warning">删除</button> ';
                                return btnHTML;
                            },
                            "targets" : 7
                        },
...
<!-- 修改问题模态框 -->
<div class="modal fade" id="askUpdateBox" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div style="width: 90%;margin: 10px auto;">
                <form class="form-horizontal" id="projectCheckForm">
                    <div class="form-group">
                        <label class="col-sm-4 control-label">提问id</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="DataInput form-control" name="courseName" id="courseName" >
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="submitAskUpdateBox()">提交</button>
            </div>
        </div>
    </div>
</div>
<script type="text/javascript">
     ...
     * 打开修改框
     */
    function askUpdateBox(id,fromId,userName,toId,courseName,content,addTime) {
        $("#id").attr("value",id);
        $("#fromId").attr("value",fromId);
        $("#userName").attr("value",userName);
        $("#toId").attr("value",toId);
        $("#courseName").attr("value",courseName);
        $("#content").html(courseName);
